...
if(isset($_POST["register"]))
{
 ...
 ";
 $statement = $objPDO->prepare($check_query);
 $check_data = array(
  ':username'  => $username
 );
 if($statement->execute($check_data)) 
 {
  ...
  else
  {
   ...
   if($message == '')
   {
    $objReg = new Logindb($objPDO);
    $objReg->setUsername($username);
    $objReg->setPassword(password_hash($password, PASSWORD_DEFAULT));
