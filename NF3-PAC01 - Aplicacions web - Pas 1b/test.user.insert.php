<?php
        ...
        $objUser3->setFirstName("LOG");
        $objUser3->setLastName("TEXT") ;
        $objUser3->setUsername("TEXTLOG");
        $objUser3->setPassword("aaaa");
        $objUser3->setEmailAddress("textlog@email.com");
        $objUser3->setDateLastLogin("2024-02-28");
        $objUser3->setTimeLastLogin("00:35:24");
        $objUser3->setDateAccountCreated("2022-04-23");
        $objUser3->setTimeAccountCreated("14:23:51");

        $objUser3->Save();

        print "Ultimo usuario: <br />";
